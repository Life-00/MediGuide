              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="mt-8 flex justify-center gap-3 flex-wrap">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-white bg-indigo-600 border border-indigo-600 px-4 py-2 rounded-full hover:bg-indigo-700 hover:border-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    type="button"
                    disabled={disabled}
                  >
                    📄 내용증명서 작성
